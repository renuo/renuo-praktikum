        ...
        <div class="section-year">
          <p v-if="hasYear(timelineContent)" class="year">
            {{ getYear(timelineContent)
              ...
              hasToYear(timelineContent)
                ? " / " + getToYear(timelineContent)
                : ""
            }}
          </p>
        </div>
...
export default {
  ...
  methods: {
    ...
    getToYear(date) {
      ...
      return date.to.getFullYear();
    },
    hasYear(dataTimeline) {
      return !!dataTimeline.from && dataTimeline.from !== undefined;
    },
    hasToYear(dataTimeline) {
      return !!dataTimeline.to && dataTimeline.to !== undefined;
    },
