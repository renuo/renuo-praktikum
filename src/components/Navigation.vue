    ...
    <div id="myNav" class="overlay">
      ...
      <div class="overlay-content">
        <div class="overlay-links">
          ...
          >
          <br />
          <a href="#" @click.prevent="passUpNewBody('internship')">Praktikum</a>
          <br />
          <a href="#" @click.prevent="passUpNewBody('projects')">Projekte</a>
          <br />
          <a href="#" @click.prevent="passUpNewBody('challenges')"
            >Challenges</a
          >
          <br />
          ...
          ></a>
          <br />
          <a href="#" @click.prevent="passUpNewBody('gallery')">Gallery</a>
        </div>
        <br />
      </div>
    </div>
...
.overlay a {
  ...
  font-size: $navigation-link-size;
